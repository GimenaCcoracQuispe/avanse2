...
<body class="sb-nav-fixed">
	...
	<!-- VALIDACION CAMPO TIPO DE USUARIO -->
	<script>
    // Obtener el elemento del campo de selección de tipo de usuario
    ...
    // Función para validar el tipo de usuario seleccionado
    ...
    frmTypeUserSelect.addEventListener('focus', function() {
        // Restablecer la validación personalizada al enfocar el campo
        frmTypeUserSelect.setCustomValidity('');
    });
    ...
    frmTypeUserSelect.addEventListener('invalid', function() {
        // Obtener el elemento de retroalimentación de validación inválida
        var invalidFeedback = document.getElementById('frmType_user').nextElementSibling;
        
        // Mostrar el mensaje de retroalimentación con el nombre completo de la opción seleccionada
        invalidFeedback.innerHTML = 'Por favor, seleccione una opción válida: ' + selectedOption.getAttribute('data-fullname') + '.';
    });
</script>
