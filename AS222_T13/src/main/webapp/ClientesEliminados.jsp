...
<body class="sb-nav-fixed">
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4">Clientes Inactivos</h1>
					<div class="card-body">
					...
					<div class="card" id="divRegistro" style="display: none;">
						...
						<div class="card-body">
							<form class="row g-3 needs-validation" novalidate>
								...
								<div class="row mb-3" id='grupo_grado'>
									<label for="frmGrade" class="col-sm-2 col-form-label">Grado</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" maxlength="1"
											id="frmGrade" name="grado">
										<div class="valid-feedback">¡El grado es correcto!</div>
										<div class="invalid-feedback">El campo Grado solo admite
											número del 1° al 5°.</div>
									</div>
								</div>
								
								
								<div class="col-md-4">
									<label for="frmSection" class="form-label">Sección</label> <input
										type="text" class="form-control" id="frmSection" value=""
										required>
									<div class="valid-feedback">¡Se ve bien!</div>
									<div class="invalid-feedback">Por favor, coloque algo
										válido.</div>
	...
	function fnBtnActualizar() {
		...
		xhttp.open("GET", "StudentHistorial", true);
